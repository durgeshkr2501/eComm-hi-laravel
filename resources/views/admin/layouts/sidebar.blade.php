...
<aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="index.html">
          <img src="/admin-theme/assets/images/logo/logo.svg" alt="logo" />
        </a>
      </div>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            <a
              ...
              class="collapsed"
              data-bs-toggle="collapse"
              data-bs-target="#Products_menu"
              aria-controls="Products_menu"
              aria-expanded="false"
              aria-label="Toggle navigation"
            >
              <span class="icon">
            ...
            <ul id="Products_menu" class="collapse dropdown-nav">
              <li>
                <a href="{{ route('products.listing') }}"> Listing </a>
              </li>
              <li>
                <a href="{{ route('products.create-product') }}"> New product </a>
              </li>
            </ul>
             </li>
            ...
            <ul id="Category_menu" class="collapse dropdown-nav">
              <li>
